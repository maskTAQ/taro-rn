...
const store = {
    ...
    data: offerList.concat(demandList, ['my_demand_list', 'user', 'shoppingCarList', 'my_offer_list', 'my_cloud_offer_list', `demand_list_全部`, 'auth','logistics_list','my_logistics_list']),
};
